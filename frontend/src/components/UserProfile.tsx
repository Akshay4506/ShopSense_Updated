                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                    <DropdownMenuLabel className="font-normal">
                        <div className="flex flex-col space-y-1">
                            <p className="text-sm font-medium leading-none">{shopkeeperName || "Shop Owner"}</p>
                        ...
                        <form onSubmit={handleProfileUpdate} className="space-y-4 py-4">
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="shop-name" value={shopName} onChange={(e) => setShopName(e.target.value)} className="pl-10" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="owner-name" value={shopkeeperName} onChange={(e) => setShopkeeperName(e.target.value)} className="pl-10" />
                                </div>
                            </div>
                            <div className="space-y-2">
